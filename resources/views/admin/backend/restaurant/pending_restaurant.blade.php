           ...
           @foreach ($client as $key=> $item)
            <tr>
                ...
                <td>
                    ...
                    @else
                    <span class="text-danger"><b>Inapprove</b></span>
                    @endif
                </td>

        <td>
        <input data-id="{{$item->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Approved" data-off="Inapprove" {{ $item->status ? 'checked' : '' }}>
