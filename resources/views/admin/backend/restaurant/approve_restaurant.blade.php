...
<div class="page-content">
    <div class="container-fluid">
        ...
        <td>
        <input data-id="{{$item->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Approved" data-off="Decline" {{ $item->status ? 'checked' : '' }}>
